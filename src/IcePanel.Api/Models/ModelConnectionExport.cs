...
namespace IcePanel.Api.Models
{
    ...
    public partial class ModelConnectionExport : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::IcePanel.Api.Models.ModelConnectionExport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::IcePanel.Api.Models.ModelConnectionExport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::IcePanel.Api.Models.ModelConnectionExport();
        }
        /// <summary>
